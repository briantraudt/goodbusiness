          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start">
                ...
                <a href="mailto:hello@goodbusiness.com" className="text-gray-300 hover:text-gb-green transition-colors">
                  hello@goodbusiness.com
                </a>
              </li>
              <li className="flex items-start">
                <Phone className="mr-3 h-5 w-5 text-gb-green" />
                <a href="tel:+15551234567" className="text-gray-300 hover:text-gb-green transition-colors">
                  (555) 123-4567
                </a>
              </li>
              <li className="flex items-start">
