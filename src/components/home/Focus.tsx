      ...
      <div className="container-custom py-10 md:py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-10 max-w-5xl mx-auto">
          {focusAreas.map((area, index) => (
            <div key={index} className="bg-white p-6 md:p-8 rounded-sm border border-gray-200 shadow-sm hover:shadow-md transition-all flex flex-col">
              ...
              <div className="mt-auto">
                <Button asChild variant="outline" className="border-gb-blue text-gb-blue hover:bg-gb-blue/5 flex items-center justify-center w-full text-base rounded-sm">
                  <Link to={area.link}>
                    {area.linkText}
                  </Link>
                </Button>
