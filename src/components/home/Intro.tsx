      ...
      <div className="container-custom section-padding">
        <div className="max-w-3xl mx-auto text-center">
          <p className="text-xl md:text-2xl text-gb-dark/80 leading-relaxed">
            We believe a <span className="text-gb-green font-medium">Good Business</span> should have two things:<br />
            <span className="font-semibold">Be Transforming + Be Profitable</span>.<br />
